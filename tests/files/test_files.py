...
from clients.files.file_schema import CreateFileRequestSchema, CreateFileResponseSchema, GetFileRequestSchema
...
class TestFiles:
    ...
    def test_get_file(self, files_client: FilesClient, function_file: FileFixture):
        ...
        response_data = GetFileRequestSchema.model_validate_json(response.text)
