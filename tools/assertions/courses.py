...
def assert_update_course_response(request: UpdateCourseRequestSchema, response: UpdateCourseResponseSchema):
    ...
    :param response: Ответ с обновленными данными.
...
def assert_get_courses_response(
    ...
    for index, create_courses_response in enumerate(create_course_responses):
...
def assert_create_course_response(
    ...
    :param response: Ответ с созданным курсом.
    :raises AssertionError: Если хотя бы одно поле не совпадает.
    """
